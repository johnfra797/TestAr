...
namespace TestAr.WebII.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var usuarioLogin = servicioAplicacionUsuario.Login(model.Email, model.Password);
            if (usuarioLogin != null)
            {
                SignInAsync(usuarioLogin);
        ...
        private void SignInAsync(UsuarioDTO usuario)
        {
            var claims = new List<Claim>();
            claims.Add(new Claim(ClaimTypes.Name, usuario.Nombre));
            claims.Add(new Claim(ClaimTypes.Email, usuario.Email));
            claims.Add(new Claim(ClaimTypes.Role, usuario.RoleAsociado.Nombre));
